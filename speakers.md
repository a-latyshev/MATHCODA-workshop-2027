...
* **Research Interests**: Directional data analysis, shape analysis, likelihood inference, spatial statistics, diffusion processes.
* **Talk Title**: *To be announced*
* **Abstract**: [Read Abstract Placeholder](abstracts/index.md#john-kent)
:::
...
* **Research Interests**: Mathematical statistics, econometrics, high-dimensional causal inference, double/debiased machine learning.
* **Talk Title**: *To be announced*
* **Abstract**: [Read Abstract Placeholder](abstracts/index.md#victor-chernozhukov)
:::
...
* **Track**: Day 3 — Probability
* **Session Details**: Wednesday, 27 January 2027, 09:00–09:45
...
* **Track**: Day 4 — Uncertainty Quantification in Engineering Applications
* **Session Details**: Thursday, 28 January 2027, 09:00–09:45
* Announcement forthcoming.
:::
...
*Interests*: Surrogate modeling, shifted boundary finite element methods, physics-informed neural networks (PINNs), and high-performance scientific computing.  
[Session Details & Abstracts](abstracts/index.md#day-4-engineering)
:::
